...
<html lang="en">
   ...
   <body background="<?php echo base_url('images/bg.jpg'); ?>">
      ...
      <div class="container">
          <h1 style="color:white">Edit Faculty List</h1>
      ...
      <p>Note:Faculty can be deleted only after removal of the Faculty corresponding courses</p>
      </div>
      <!--  must for delete functionality,i have already written below in usermodal so i commented this
         <div><input type="text" name="user_i" id="user_i"/></div>-->
      <!--update dialog box-->
      ...
      <script>
         ...
         $(document).ready(function(){
           ...
           $(document).on('click','.delete',function(){
             ...
             if(confirm("Are you sure you want to delete this student?"))
             {
                 ...
                 $.ajax({
                      url:"<?php echo site_url()?>/FacultySearchCon/deleteStudent",
                      method:"POST",
           ...
           //userd is used as input ie., this will have the useridd which is used while quering 
            $.ajax({
                      url:"<?php echo site_url()?>/FacultySearchCon/fetch_single_user",
                      method:"GET",
                      data:{userd:useridd},
                      datatype:"json",
                      success:function(data){
                         ...
                         $('#userModal').modal('show');
                          $('#userModal').find('.modal-title').text("Edit Faculty Data");
         ...
         $(document).on('submit', '#user_form', function(event){  
                ...
                {  
                     $.ajax({  
                          url:"<?php echo site_url()?>/FacultySearchCon/user_action",  
                          method:'POST',  
