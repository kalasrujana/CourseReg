...
<html>
   <head>
      ...
      <style>
         ...
         td{color:white;padding-right: 10px}
      </style>
   </head>
   <body background="<?php echo base_url('images/bg.jpg'); ?>">
      ...
      <center>
         <h1 style="margin-top:120px;color:white;margin-bottom: 50px">Faculty Login</h1>
         <form action="" method="POST">
            <table>
               <tbody>
                  <tr>
                     <td>User Name</td>
                     <td><input style="margin-bottom:10px" autofocus="autofocus" class="btn btn-default" id="uName" type="text" name="uName" value="<?php echo set_value('uName'); ?>" /></td>
                  </tr>
                  <tr>
                     <td>Password</td>
